...
<Frame caption="Choose the network, model, and App from the same surface where you describe what should happen onchain.">
  <img src="/images/chat/portal-home.jpg" alt="The Aomi Chat home screen with network, model, App, and message controls" />
</Frame>
