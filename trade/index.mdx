...
Want your first trade end to end? The [client CLI reference](/reference/cli) covers install, the transaction flow, and every flag and command. To see the exact commands the agent runs, read [how execution works](/trade/execution).

<CardGroup cols={2}>
  <Card title="Use the CLI" icon="terminal" href="/reference/cli">
