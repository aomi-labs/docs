...
Run the [Widget Installation](/guides/widget-installation) guide to install the widget into a Next.js app in one command, or read [How It Works](/concepts/how-it-works) for the full pipeline.
...
- [Client CLI](/reference/cli): install and use the aomi command
