...
- **Account abstraction support.** Gas sponsorship via paymasters and batched operations in a single user-op. See [Account Abstraction](/reference/account-abstraction).
