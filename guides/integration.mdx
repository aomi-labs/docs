---
title: "Overview"
description: "Full-stack Aomi integration walkthrough. Wrap APIs as tools, configure an App with preamble and model, and deploy across web and Telegram channels."
---
...
**Preamble** is the system prompt that shapes the AI's personality, constraints, and rules. A well written preamble keeps the AI on task and prevents overstepping.
