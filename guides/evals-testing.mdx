---
title: Evals & Testing
description: Evaluate Aomi prompts, tool calls, and wallet flows with deterministic assertions running against forked mainnet state for safe automated regression testing.
---

The evaluation framework lets you test AI assistant behavior with deterministic assertions. Use it to validate tool calling, transaction flows, and response quality.

Run tests against forked mainnet state to verify that agents correctly execute blockchain operations.
