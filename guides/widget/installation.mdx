...
<Note>
  Explicit provider props describe the current source contract. Check your installed widget release and provider allowlists before using the example. See [package and API compatibility](/integrate/client-sdk#check-compatibility).
</Note>
