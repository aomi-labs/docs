...
description: Reference for every hook exported by @aomi-labs/react. Covers useAomiRuntime, message and thread state, streaming, tool calls, and wallet interaction APIs.
---
...
- [Headless Library](/guides/headless-library): runtime provider setup
