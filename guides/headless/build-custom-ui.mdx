...
description: "Build a custom Aomi interface with @aomi-labs/react. Set up the provider, render messages, submit input, and stream responses."
---
...
- [Custom Tools](/build/plugins/custom-tools): extend with your own tools
