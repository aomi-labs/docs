...
description: Build a fully custom Aomi chat interface from scratch using only @aomi-labs/react hooks — provider setup, message rendering, input, and streaming responses.
---
