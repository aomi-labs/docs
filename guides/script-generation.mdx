...
description: Generate and execute Foundry/Forge scripts from natural language with Aomi — ForgeExecutor compilation, dependency resolution, and broadcastable transactions.
---
