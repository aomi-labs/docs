...
description: Install and configure the Aomi chat widget via the shadcn registry — components.json setup, package install, environment variables, and embedding AomiFrame.
---
