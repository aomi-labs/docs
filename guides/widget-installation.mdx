...
description: "Install AomiFrame in a Next.js 15 App with shadcn. Configure the environment, mount the widget, and review its component API."
sidebarTitle: "Widget Installation"
---

<Info>
  Want the terminal instead of a frontend? The [client CLI reference](/reference/client-cli) covers the `aomi` client CLI. This page covers installing and using the chat widget in a Next.js app.
</Info>
...
- [Quickstart](/guides/widget/quickstart): choose widget vs headless
- [Headless Library](/guides/widget/customization#build-a-headless-ui): build custom UI
