...
<Info>
  Want the terminal instead of a frontend? The [client CLI reference](/reference/cli) covers the `aomi` client CLI. This page covers installing and using the chat widget in a Next.js app.
</Info>
