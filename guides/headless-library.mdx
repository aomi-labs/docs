...
description: "Build a custom Aomi interface with the @aomi-labs/react headless library. Use its runtime state, hooks, and API client without adopting a preset UI."
---
...
See the [Hooks Reference](/guides/widget/customization#hooks) for the full `useWalletHandler` API and result shapes.
...
- [Hooks Reference](/guides/widget/customization#hooks): complete hook API
- [Build Custom UI](/guides/widget/customization#complete-custom-ui-example): full example from scratch
- [Custom Tools](/build/plugins/custom-tools): extend Aomi with your own tools
