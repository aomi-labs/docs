...
description: Build custom chat UIs with the @aomi-labs/react headless library. Runtime logic, state management, hooks, and an API client with zero UI opinions for builders.
---
...
See the [Hooks Reference](/guides/headless/hooks) for the full `useWalletHandler` API and result shapes.
