...
description: Fixes for common Aomi integration issues — CLI command-not-found errors, widget mounting problems, missing environment variables, and wallet connection bugs.
---
...
- Both share the same backend — switch between them without server changes

## API Issues

**401 Unauthorized**
No API key provided. Add an `X-API-Key` header or enter it in the control bar.
