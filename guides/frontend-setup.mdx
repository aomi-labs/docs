...
description: "Add the Aomi widget to a Next.js 15 product. Install it with shadcn, configure the environment, and mount the App-bound interface."
---

<Info>
  Looking for install steps? See [Installation](/guides/widget/installation) for the one-command shadcn install.
</Info>
...
→ [Headless Library](/guides/widget/customization#build-a-headless-ui) covers the alternative path.
...
- [Installation](/guides/widget/installation): install with one command.
- [Installation](/guides/widget/installation): props, compound API, and customization.
- [Headless Library](/guides/widget/customization#build-a-headless-ui): build your own UI.
- [Apps & Authentication](/reference/apps-and-authentication): how API keys and Apps work.
