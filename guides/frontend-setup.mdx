...
<Info>
  Looking for install steps? See [Widget Installation](/guides/widget-installation) for the one-command shadcn install.
</Info>
...
- [Widget Installation](/guides/widget-installation): install with one command.
