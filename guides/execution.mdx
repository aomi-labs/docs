---
title: Execution
description: Full transaction execution lifecycle in Aomi — Anvil fork management, simulation tools, and wagmi wallet integration from proposal to on-chain settlement.
---
