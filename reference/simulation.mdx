...
For the full host capability contract, see [Building Apps](/build/plugins/anatomy).
...
- [Building Apps](/build/plugins/anatomy): host tool contract for staging and committing
