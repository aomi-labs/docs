---
title: aomi CLI reference
description: Reference for the aomi executable from @aomi-labs/client. Chat with an Aomi backend, persist sessions, inspect and sign wallet requests, manage models, apps, chains, and secrets.
---
...
If you are building and shipping an Agentic Application, you want the Rust SDK tools `aomi-build`, `aomi-run`, and `aomi-git` instead. See [the builder CLI reference](/reference/cli-toolchain) for those. This page covers only the npm `aomi` client.
</Warning>
...
<CardGroup cols={2}>
<Card title="CLI usage guide" href="/guides/cli-usage" icon="book">
A task focused walkthrough of common CLI flows.
</Card>
<Card title="Builder CLI" href="/reference/cli-toolchain" icon="wrench">
