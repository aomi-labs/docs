...
If you are building and shipping an Agentic Application, you want the Rust SDK tools `aomi-build` and `aomi-run` instead. See [the builder toolchain](/reference/cli-toolchain) for those. This page covers only the npm `aomi` client.
</Warning>
