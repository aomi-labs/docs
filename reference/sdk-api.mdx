---
title: SDK
description: Rust SDK reference for building agentic applications on Aomi — ChatApp, ForgeApp, L2BeatApp, the builder pattern, custom tools, streaming, and system events.
---
