---
title: Runtime
description: "Trace an App turn through loading, model and tool orchestration, user state, simulation, wallet callbacks, and streaming events."
---
...
See [Aomi App](/build/plugins/aomi-app) and [Rust SDK](/build/plugins/rust-sdk) for the authoring contract.
...
For transaction details, see [Simulation Reference](/reference/simulation-reference) and [Accounts and wallets](/concepts/accounts-and-wallets).
...
- [Simulation Reference](/reference/simulation-reference): transaction simulation and failure handling.
- [API Reference](/reference/api-reference): HTTP endpoints and payloads.
- [Rust SDK](/build/plugins/rust-sdk): App authoring, `DynAomiTool`, and `dyn_aomi_app!`.
- [Builder toolchain](/build/toolchain/aomi-build): local App testing and toolchain commands.
