...
See [Building an App](/build/plugins/anatomy) and [SDK reference](/build/plugins/sdk) for the authoring contract.
...
- [SDK reference](/build/plugins/sdk): App authoring, `DynAomiTool`, and `dyn_aomi_app!`.
