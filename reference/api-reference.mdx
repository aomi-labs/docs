---
title: API Reference
description: HTTP API reference for the Aomi backend — authentication headers, session endpoints, message streaming, tool call payloads, and wallet request callbacks.
---
