---
title: API Reference
description: "Use the Aomi HTTP API for sessions, chat, state, real-time updates, and control actions. Includes authentication headers and endpoint behavior."
---
...
- [Aomi App](/build/plugins/aomi-app): App configuration and deployment
