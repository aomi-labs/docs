---
title: Sessions
description: "Understand how Aomi creates, restores, and persists chat sessions, including thread history and conversation lifecycle behavior."
---
...
- [Headless Library](/guides/widget/customization#build-a-headless-ui): build custom session UIs with @aomi-labs/react.
- [Installation](/guides/widget/installation): install and configure the widget.
