...
description: Embedding Aomi agentic chat directly inside wallets like MetaMask with tool calling, streaming responses, and onchain operations without leaving the wallet UI.
---
...
- [How It Works](/concepts/how-it-works): understand the integration flow
