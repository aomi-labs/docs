...
<CardGroup cols={2}>
  <Card title="Polymarket" icon="chart-line" href="/examples/polymarket">
    Prediction market data and on-chain trading via Polymarket's public API.
  </Card>
  ...
  <Card title="MetaMask" icon="wallet" href="/examples/metamask">
    Embedding Aomi chat within wallets and wallet extensions.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Integration Guide" icon="plug" href="/guides/integration">
    Full-stack walkthrough — APIs to a deployed Aomi App.
  </Card>
