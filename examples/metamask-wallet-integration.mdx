...
description: "See how wallets such as MetaMask can embed Aomi chat, tool calls, streaming responses, and onchain actions in their own UI."
---
...
- [Transaction pipeline](/concepts/transaction-pipeline): understand the integration flow
