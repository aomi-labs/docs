...
description: Aomi tools for DeFi aggregation across DefiLlama prices and yields, 0x and LI.FI swap routing, and CoW Protocol intent-based batch settlement.
---
