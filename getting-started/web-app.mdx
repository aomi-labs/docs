---
title: Web App
description: "Use chat.aomi.dev to inspect balances, swap, bridge, and manage onchain activity from one browser session."
---
...
- [What is Aomi?](/build/overview): understand how Aomi works
