---
title: "Telegram Bot"
description: "Use Aomi through the SendIt Telegram bot. Connect a non-custodial wallet, run commands, and keep conversation history across devices."
---
...
- [Aomi App](/build/plugins/aomi-app): define tools and preambles
- [Aomi App](/build/plugins/aomi-app): define tools, preambles, and model selection for your bot's backend
- [Wallet Integration](/concepts/accounts-and-wallets): connect wallet features to the Telegram mini-app
- [Apps](/build/plugins/aomi-app): route bot traffic to the correct backend app
