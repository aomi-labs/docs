...
- [Building Apps](/build/plugins/anatomy): define tools and preambles
- [Building Apps](/build/plugins/anatomy): define tools, preambles, and model selection for your bot's backend
- [Wallet Integration](/concepts/non-custodial-wallets): connect wallet features to the Telegram mini-app
- [Apps](/build/plugins/anatomy): route bot traffic to the correct backend app