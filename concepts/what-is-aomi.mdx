---
title: What is Aomi?
description: Aomi's core building blocks: Agentic Applications, the wallet-aware transaction runtime, embeddable chat widget, and exposing your product as AI tools.
---
...
Apps are protected by API keys scoped to that App. Pass your key via the `AOMI-APP-KEY` header, or enter it in the API key field of the control bar.
