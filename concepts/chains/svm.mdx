...
| Cluster | Accepted section names | Public default |
| --- | --- | --- |
| Mainnet Beta | `mainnet`, `mainnet-beta`, `mainnet_beta` | `https://api.mainnet-beta.solana.com` |
| Devnet | `dev`, `devnet` | `https://api.devnet.solana.com` |
| Testnet | `test`, `testnet` | `https://api.testnet.solana.com` |
| Localnet | `local`, `localhost`, `localnet` | `http://localhost:8899` |
