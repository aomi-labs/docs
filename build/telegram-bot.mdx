...
Aomi hosts the bot for you. You create a bot in Telegram, hand Aomi the token, and Aomi wires it up. You do not run a server. One bot can serve one App or several, so a single bot can front your whole catalog. Telegram is the live channel today; Discord and Slack appear on the Integrations page but are not yet available.
