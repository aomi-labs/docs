...
3. **Deploy** — the backend builds your plugin and cuts a release. Two ways
   in: [`aomi-build`](/build/toolchain/aomi-build) from your terminal,
   or the [Developer Platform](/build/platform) from your browser.
