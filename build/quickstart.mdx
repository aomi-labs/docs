...
<Steps>
  ...
  <Step title="Install the toolchain">
    This installs `aomi-git`, the tool that ships your App.
...
<Steps>
  ...
  <Step title="Request activation">
    ...
    This posts your App and release tag to the ops channel and pings ops. You do not hold the activation token, and you do not need one. Ops load your App, and within a few minutes your `greet` tool appears in the agent for new chats.
  </Step>
</Steps>

## What you have now

A live App. You wrote three files, deployed with `aomi-git deploy`, and requested activation. To go further:
