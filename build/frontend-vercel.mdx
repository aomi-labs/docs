...
description: Give your deployed plugin's widget frontend a public URL on Vercel.
---
...
- **A Next.js app with the widget installed.** [Widget Installation](/guides/widget-installation) covers the one-command shadcn install, environment variables, and mounting `AomiFrame`. [Frontend Setup](/guides/frontend-setup) covers how the widget slots into your app. The install pulls a large dependency tree, including the wallet stack; on a slow connection it takes a few minutes.
