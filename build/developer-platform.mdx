...
<Frame caption="Start from the Aomi template or import an existing GitHub repository.">
  <img src="/images/build/new-app.jpg" alt="The New app screen in Aomi Build with template and GitHub import options" />
</Frame>
