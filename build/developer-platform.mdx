...
<Frame caption="Overview is an account snapshot. Open Projects to work on an App.">
  <img src="/images/developer-console/overview.png" alt="Overview showing two Projects, zero live deployments, and shortcuts to deploy, transactions, health, and usage" />
</Frame>
...
<Frame caption="Sign in with GitHub to see your connected repositories and deployment history.">
  <img src="/images/developer-console/github-sign-in.png" alt="Projects page before sign-in with Continue with GitHub and SIGN IN badges in the sidebar" />
</Frame>
...
<Frame caption="Compare each Project’s SDK badge with the requirement above the list.">
  <img src="/images/developer-console/projects-sdk-upgrade.png" alt="Projects listing nightshift and goal-digger with Outdated badges and Upgrade buttons" />
</Frame>
...
<Frame caption="Start with a description or template, then review the plan and files.">
  <img src="/images/developer-console/build-composer.png" alt="Build composer with a description field, prompt shortcuts, and Arbitrage Bot, OpenAPI Agent, and Trading Agent templates" />
</Frame>
...
<Frame caption="Provider keys fund models; tool secrets belong in the Project’s Environment tab.">
  <img src="/images/developer-console/providers.png" alt="Providers page with OpenAI, Anthropic, and OpenRouter sections, each with an Add key button" />
</Frame>
...
<Frame caption="Create the bot in BotFather, then register it in Aomi.">
  <img src="/images/developer-console/telegram-integration.png" alt="Telegram Integrations page with BotFather setup instructions and slash-command examples" />
</Frame>
...
<Frame caption="Select the attached Apps and a primary App before registering. Change apps edits an existing bot.">
  <img src="/images/developer-console/telegram-register-bot.png" alt="Telegram registration form with a masked token, thread mode, App checkboxes, Primary selection, and an existing Active bot" />
</Frame>
...
<Frame caption="Transaction records appear after onchain activity from your Apps.">
  <img src="/images/developer-console/transactions-empty.png" alt="Transactions page with All projects selected and No transactions yet" />
</Frame>
...
<Frame caption="Read health, activity counts, and metric scope together.">
  <img src="/images/developer-console/observability.png" alt="Observability showing healthy App badges, zero activity, No data metrics, and payment health" />
</Frame>
...
<Frame caption="Use availability badges to distinguish working settings from upcoming controls.">
  <img src="/images/developer-console/settings.png" alt="Settings overview with General and Billing Available, Secrets Project-scoped, and other cards marked Soon" />
</Frame>
