...
[`DynAomiTool`](/build/plugins/rust-sdk#the-dynaomitool-trait). For patterns
such as route hints and multi-step tools, see
[Custom tools](/build/plugins/custom-tools).
...
<CardGroup cols={2}>
  ...
  <Card title="Custom tools" icon="wrench" href="/build/plugins/custom-tools">
    Design routed and multi-step tool behavior.
  </Card>
