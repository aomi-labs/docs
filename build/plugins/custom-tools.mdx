---
title: Custom tools
description: "Connect external APIs to Aomi with typed Rust tools. Implement DynAomiTool, register it, and ship the plugin as an App."
---
...
For the full plugin lifecycle (crate setup, building, and shipping), see [Aomi App](/build/plugins/aomi-app). This page focuses on the tool surface.
...
- [Aomi App](/build/plugins/aomi-app): full plugin lifecycle and host tool contract
- [Evals and testing](/build/plugins/evals-and-testing): test tool and App behavior
- [Rust SDK](/build/plugins/rust-sdk): full Rust SDK documentation
