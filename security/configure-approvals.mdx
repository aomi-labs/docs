...
<Frame caption="Open Account settings to manage automatic signing and the policy for each embedded wallet.">
  <img
    src="/images/security/wallet-signing-settings.jpg"
    alt="Aomi Account settings showing automatic signing controls and two embedded Privy wallets set to Manual"
  />
</Frame>
